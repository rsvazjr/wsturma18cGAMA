 ...
 * Regras:
 * 1º -) Não começar com números. 1berto (errado) h1berto(certo)
 * 2º -) Não utilizar palavras reservadas.
 * 3º -) Não fazer uso de caracteres especiais n@me, d@t@, tr#s...
 * 
 * Padrões:
 * - UML : Padrão para OO(Orientação ao Objeto)
